...
<body>
    ...
    <div style="height: 100%;">
        <div class="tab">
          ...
          <button class="tablinks" onclick="openCity(event, 'Paris')"><span class="glyphicon glyphicon-edit"></span>&nbsp;Đề thi đã làm</button>
          <button class="tablinks">
          <span class="glyphicon glyphicon-home"></span>&nbsp;<a style="text-decoration: none!important;" href="hinh.php">Quay lại trang chính</a></button>
      </div>
      ...
      <div id="London" class="tabcontent">
          ...
          <div class="container">
              <form method="post">
                ...
                <input type="text" id="fname" name="fullname" value="<?php echo $_SESSION['fullname1']; ?>">

                <label for="lname">Tên đăng nhập</label>
                <input type="text" id="lname" name="user" readonly="readonly" disabled="" value="<?php echo $_SESSION['user1']; ?>">

                <label>Email</label>
                <input type="text" id="" name="email" value="<?php echo $_SESSION['email1']; ?>">
              ...
              <input type="text" name="phone" placeholder="Phone number" value="<?php echo $_SESSION['phone1'];?>">
              <div align="center">
...
if(!isset($_SESSION['user1'])){
    header("location: hinh.php");
}
include 'duanweb_connect.php';
if(isset($_POST['capnhat'])){
    $sql = "update tbthanhvien set fullname='".$_POST['fullname']."', email='".$_POST['email']."', phone='".$_POST['phone']."' where user='".$_SESSION['user1']."'";
    $kq = mysqli_query($kn,$sql);
    $_SESSION['fullname1']=$_POST['fullname'];
